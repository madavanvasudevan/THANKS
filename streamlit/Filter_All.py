...
custom_css = """
<style>
    /* Replace 'your_grid_container_id' with the actual ID of your AgGrid container */
    #your_grid_container_id {
        overflow-y: auto; /* You can also use 'scroll' instead of 'auto' */
        /* Add other custom CSS styles as needed */
    }
</style>
"""
