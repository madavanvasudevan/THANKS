...
file = st.file_uploader(label="hello", type=["xlsx"], label_visibility="collapsed",key="Upset")
st.write("[Sample-Input](https://docs.google.com/spreadsheets/d/1DB-RsxfE6i1QGsXyUQfM-ZoNYHziWasg/edit?usp=sharing&ouid=103232618408666892680&rtpof=true&sd=true)")
st.write("[Sample-Output](https://docs.google.com/spreadsheets/d/196wX1Le9SvmwbWE0SmizZb_zvWjM2N6t/edit?usp=sharing&ouid=103232618408666892680&rtpof=true&sd=true)")
if file is not None:
    try:
