...
with col1:
  st.markdown("<span style='font-size: 42px;'>**TH**</span>eomics <span style='font-size: 42px;'>**AN**</span>alytics <span style='font-size: 42px;'>**K**</span>it <span style='font-size: 42px;'>**S**</span>cience", unsafe_allow_html=True)
with col2:
